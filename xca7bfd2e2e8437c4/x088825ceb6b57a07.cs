...
[DesignerCategory("")]
[DefaultEvent("")]
internal class x088825ceb6b57a07 : Button
{
	private const int xd2b41887ce266261 = 18;
	...
	private bool xc2b1260797edd6c4;

	private ContextMenuStrip x48d6c5be4ee3535d;

	private ContextMenu x4343ded86f31f623;
	...
	public override ContextMenuStrip ContextMenuStrip
	{
		get
		{
			return x80617f9edd4b550d;
		}
		set
		{
			x80617f9edd4b550d = value;
		}
	}

	[DefaultValue(null)]
	public ContextMenu xeccb35230e67456f
	{
		get
		{
			return x4343ded86f31f623;
		}
		set
		{
			if (x4343ded86f31f623 != null)
			{
				x4343ded86f31f623.Popup -= x19d8ef17b4ca8000;
			}
			if (value != null)
			{
				value.Popup += x19d8ef17b4ca8000;
			}
			x4343ded86f31f623 = value;
		}
	}

	[DefaultValue(null)]
	public ContextMenuStrip x80617f9edd4b550d
	{
		get
		{
			return x48d6c5be4ee3535d;
		}
		set
		{
			if (x48d6c5be4ee3535d != null)
			{
				x48d6c5be4ee3535d.Closing -= x69d90130ae46c040;
				x48d6c5be4ee3535d.Opening -= x7e2d33543211b46a;
			}
			if (value != null)
			{
				value.Closing += x69d90130ae46c040;
				value.Opening += x7e2d33543211b46a;
			}
			x48d6c5be4ee3535d = value;
		}
	}
	...
	private bool x970a501d4cbb1e61
	{
		get
		{
			if (x80617f9edd4b550d == null)
			{
				return xeccb35230e67456f != null;
			}
			return true;
		}
	}

	public event CancelEventHandler x9df223deb70549ad;

	public event EventHandler x0866e94d5cce8a49;

	public event EventHandler xfd092b8a1a55f3d3;

	public x088825ceb6b57a07()
	{
		AutoSize = true;
	}
	...
	protected override void Dispose(bool xb41acd866d5cbca8)
	{
		...
		{
			xeccb35230e67456f = null;
			x80617f9edd4b550d = null;
		}
		base.Dispose(xb41acd866d5cbca8);
	}

	protected virtual void OnDropDownOpening(CancelEventArgs xfbf34718e704c6bc)
	{
		this.x9df223deb70549ad?.Invoke(this, xfbf34718e704c6bc);
	}

	protected virtual void OnDropDownOpened(EventArgs xfbf34718e704c6bc)
	{
		this.x0866e94d5cce8a49?.Invoke(this, xfbf34718e704c6bc);
	}

	protected virtual void OnDropDownClosed(EventArgs xfbf34718e704c6bc)
	{
		this.xfd092b8a1a55f3d3?.Invoke(this, xfbf34718e704c6bc);
	}

	protected override bool IsInputKey(Keys x7164e699dd95323c)
	{
		if (x7164e699dd95323c.Equals(Keys.Down) && x970a501d4cbb1e61)
		{
			return true;
		}
	...
	protected override void OnKeyDown(KeyEventArgs xabade24c69547bb4)
	{
		if (x970a501d4cbb1e61)
		{
			if (xabade24c69547bb4.KeyCode.Equals(Keys.Down) && !xc2b1260797edd6c4)
			{
				x18c7810149270b9e();
			}
	...
	protected override void OnKeyUp(KeyEventArgs xabade24c69547bb4)
	{
		...
		else if (xabade24c69547bb4.KeyCode.Equals(Keys.Apps) && Control.MouseButtons == MouseButtons.None && !xc2b1260797edd6c4)
		{
			x18c7810149270b9e();
		}
	...
	protected override void OnMouseDown(MouseEventArgs xfbf34718e704c6bc)
	{
		...
		if (x4343ded86f31f623 != null && xfbf34718e704c6bc.Button == MouseButtons.Left && !xdeb4d3f039e6d708)
		{
			x3801fb00f092121c = true;
		}
		if (!xc2b1260797edd6c4 && xfbf34718e704c6bc.Button == MouseButtons.Left)
		{
			x18c7810149270b9e();
		}
		else
	...
	protected override void OnMouseUp(MouseEventArgs x797b7706f394da27)
	{
		...
		else if (x797b7706f394da27.Button == MouseButtons.Right && base.ClientRectangle.Contains(x797b7706f394da27.Location) && !xc2b1260797edd6c4)
		{
			x18c7810149270b9e();
		}
		else if ((x48d6c5be4ee3535d == null && x4343ded86f31f623 == null) || !xc2b1260797edd6c4)
		{
			x5379115e1ccee283();
		}
	}
	...
	protected override void OnPaint(PaintEventArgs x6e8f4405e0958692)
	{
		...
		Rectangle x7b34bad9328ee55d = new Rectangle(clientRectangle.Right - 18, 0, 18, clientRectangle.Height);
		int num = x5a2e5f1a044abafd;
		Rectangle rectangle = new Rectangle(num - 1, num - 1, clientRectangle.Width - num * 2 + 2, clientRectangle.Height - num * 2 + 2);
		if (RightToLeft == RightToLeft.Yes)
		{
			x7b34bad9328ee55d.X = clientRectangle.Left + 1;
		}
		x70af040924580888(graphics, x7b34bad9328ee55d);
	...
	private void x18c7810149270b9e()
	{
		...
		if (!cancelEventArgs.Cancel)
		{
			...
			if (x4343ded86f31f623 != null)
			{
				...
				x4343ded86f31f623.Show(this, new Point(0, base.Height));
			}
			else if (x48d6c5be4ee3535d != null)
			{
				OnDropDownOpened(EventArgs.Empty);
				x48d6c5be4ee3535d.Show(this, new Point(0, base.Height), ToolStripDropDownDirection.BelowRight);
			}
		}
	}

	private void x7e2d33543211b46a(object xe0292b9ed559da7d, CancelEventArgs xfbf34718e704c6bc)
	{
		xc2b1260797edd6c4 = true;
	}

	private void x69d90130ae46c040(object xe0292b9ed559da7d, ToolStripDropDownClosingEventArgs xfbf34718e704c6bc)
	{
		xc2b1260797edd6c4 = false;
		x5379115e1ccee283();
		if (xfbf34718e704c6bc.CloseReason == ToolStripDropDownCloseReason.AppClicked)
		{
			x3801fb00f092121c = base.ClientRectangle.Contains(PointToClient(Cursor.Position)) && Control.MouseButtons == MouseButtons.Left;
		}
		OnDropDownClosed(EventArgs.Empty);
	}

	private void x19d8ef17b4ca8000(object xe0292b9ed559da7d, EventArgs xfbf34718e704c6bc)
	{
		xc2b1260797edd6c4 = true;
	}
	...
	{
		if (base.ClientRectangle.Contains(PointToClient(Cursor.Position)))
		{
			xffb3238a8fd59aa7 = PushButtonState.Hot;
		}
		else if (Focused)
