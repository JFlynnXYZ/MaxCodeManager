...
public class x325527706166bcaf : Form
{
	...
	private Codelist x06ca69422bbb7502;

	private List<GameEntry> xe858f6a4b95d2b29;

	private Codelist x2e26bc427243234e;

	private Codelist x93c06c96f0e1cbb2;

	private Codelist x0916a2b56e31172c;

	private FavouriteGames x7f7aa52be0bee831;

	[CompilerGenerated]
	private static Comparison<GameEntry> xb52cc720056569fd;
	...
	public x325527706166bcaf(string xc15bd84e01929885, Codelist list, Codelist xd75e60e5e359bba6, Codelist x674c7a44ab7af2f3, Codelist x9bb25319cdbbd9cc)
	{
		x85601834555fb7d5();
		Text = string.Format(CultureInfo.CurrentCulture, "{0} ({1})", Text, xc15bd84e01929885);
		x06ca69422bbb7502 = list;
	...
	{
		xe858f6a4b95d2b29 = new List<GameEntry>(x06ca69422bbb7502);
		xe858f6a4b95d2b29.Sort(delegate(GameEntry x08db3aeabb253cb1, GameEntry x1e218ceaee1bb583)
		{
			...
			return (x1e218ceaee1bb583 == null) ? 1 : string.Compare(x08db3aeabb253cb1.Name, x1e218ceaee1bb583.Name, ignoreCase: true);
		});
	...
	{
		GameEntry xa0380078f0b6cbb = xe858f6a4b95d2b29[xfbf34718e704c6bc.ItemIndex];
		xfbf34718e704c6bc.Item = new ListViewItem(new string[xa5a29a37143fc578.Columns.Count]);
		xfbf34718e704c6bc.Item.SubItems[x2ad481aace84dd1e.Index].Text = xa0380078f0b6cbb.Name;
		...
		xfbf34718e704c6bc.Item.SubItems[xb598d2f391288f75.Index].Text = xa0380078f0b6cbb.Region.ToString();
	...
	private void x1ac0a57fa7fa7e92(object xe0292b9ed559da7d, SearchForVirtualItemEventArgs xfbf34718e704c6bc)
	{
		if (xfbf34718e704c6bc.IsTextSearch)
		{
			...
			Predicate<GameEntry> match = (GameEntry game) => game.Name.StartsWith(text, StringComparison.CurrentCultureIgnoreCase);
	...
	{
		GameEntry xa0380078f0b6cbb = xe858f6a4b95d2b29[xfbf34718e704c6bc.Index];
	...
	private bool xd65fb623169e7ad7(GameEntry game)
	{
		return x2e26bc427243234e.x45a46c637b44a527(game.x52b8174788d367f9) != null;
	}
	...
	private void xc72ea7635237e180(object xe0292b9ed559da7d, EventArgs xfbf34718e704c6bc)
	{
		...
		foreach (int selectedIndex in xa5a29a37143fc578.SelectedIndices)
		{
			GameEntry xa0380078f0b6cbb = xe858f6a4b95d2b29[selectedIndex];
	...
	private void x5ba87f6bea7c94f7(object xe0292b9ed559da7d, EventArgs xfbf34718e704c6bc)
	{
		...
		if (x2e26bc427243234e == x06ca69422bbb7502 && count >= 1 && MessageBox.Show(this, "Are you sure you want to remove the selected game(s) from the active codelist?\r\n\r\n(If you don't have them in another list, you won't be able to get them back.)", "Confirm game removal", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.Yes)
		{
			...
			{
				GameEntry x6849540e228fbc = xe858f6a4b95d2b29[array[num]];
	...
	private void x3a38ce109ba7ad0e(object xe0292b9ed559da7d, EventArgs xfbf34718e704c6bc)
	{
		...
		GameEntry xa0380078f0b6cbb = xe858f6a4b95d2b29[xa5a29a37143fc578.SelectedIndices[0]];
		if (xa0380078f0b6cbb == null)
		{
			return;
		}
		GameEntry x44f5de605a = ((x0916a2b56e31172c == null) ? null : x0916a2b56e31172c.x45a46c637b44a527(xa0380078f0b6cbb.x52b8174788d367f9));
	...
	private void xdb99f6f19adece6d(object xe0292b9ed559da7d, EventArgs xfbf34718e704c6bc)
	{
		...
		game.Name = x1536525b14cf2193.xb0b4ff1622a01d12.Name;
		...
		OnActiveListChanged(EventArgs.Empty);
		xeb0bb1fd8b3dbf7b();
		int num = xe858f6a4b95d2b29.FindIndex((GameEntry xb5d079ea7e672a45) => xb5d079ea7e672a45.x52b8174788d367f9 == game.x52b8174788d367f9);
		if (num != -1)
		{
	...
	[CompilerGenerated]
	private static int x26b645d36a3189bb(GameEntry x08db3aeabb253cb1, GameEntry x1e218ceaee1bb583)
	{
		if (x08db3aeabb253cb1 == null && x1e218ceaee1bb583 == null)
		{
			return 0;
		...
		return string.Compare(x08db3aeabb253cb1.Name, x1e218ceaee1bb583.Name, ignoreCase: true);
	}
}
