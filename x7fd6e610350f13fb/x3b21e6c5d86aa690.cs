...
{
	public static void xe0fbb350f1c86030(string x1b18a3a0e8682b51, xc68feac946ffcf6f xcdb38db96792af75, string xb41a802ca5fde63b)
	{
		...
		streamWriter.WriteLine("# Version: {0}   Region: {1}", xcdb38db96792af75.x9425d7602dc80ff4.x77fa6322561797a0, xcdb38db96792af75.x9425d7602dc80ff4.x9b7a81a8f32a1422);
		streamWriter.WriteLine("# {0:s}", DateTime.Now);
		streamWriter.WriteLine("############################################");
		streamWriter.WriteLine();
		streamWriter.WriteLine();
		foreach (xa0380078f0b6cbb7 item in xcdb38db96792af75.x9425d7602dc80ff4)
		{
			streamWriter.WriteLine("* {0}", item.x759aa16c2016a289);
			...
			foreach (xbabc9feec6f641db item2 in item)
			{
				...
				string[] array = item2.x7e5b09fa2269d9a5.xa9edb3b115d067da();
				string[] array2 = array;
	...
	public static void xee53a77bb6ce3bd7(string x1b18a3a0e8682b51, xc68feac946ffcf6f xcdb38db96792af75, string xb41a802ca5fde63b)
	{
		using FileStream xcf18e5243f8d5fd = new FileStream(xb41a802ca5fde63b, FileMode.Create, FileAccess.Write, FileShare.None);
		xb10a7180e3ae07cc(x1b18a3a0e8682b51, xcdb38db96792af75, xcf18e5243f8d5fd);
	}

	private static void xb10a7180e3ae07cc(string x1b18a3a0e8682b51, xc68feac946ffcf6f xcdb38db96792af75, Stream xcf18e5243f8d5fd3)
	{
		...
		xmlWriter.WriteElementString("Version", xcdb38db96792af75.x9425d7602dc80ff4.x77fa6322561797a0.ToString(CultureInfo.InvariantCulture));
		xmlWriter.WriteElementString("Region", xcdb38db96792af75.x9425d7602dc80ff4.x9b7a81a8f32a1422.ToString());
		foreach (xa0380078f0b6cbb7 item in xcdb38db96792af75.x9425d7602dc80ff4)
		{
			xmlWriter.WriteStartElement("Game");
			xmlWriter.WriteAttributeString("Id", item.x52b8174788d367f9.ToString(CultureInfo.InvariantCulture));
			xmlWriter.WriteElementString("Name", item.x759aa16c2016a289);
	...
	public static void x7d1fb3e819ed7b11(string x1b18a3a0e8682b51, xc68feac946ffcf6f xcdb38db96792af75, string xb41a802ca5fde63b)
	{
		using MemoryStream memoryStream = new MemoryStream();
		xb10a7180e3ae07cc(x1b18a3a0e8682b51, xcdb38db96792af75, memoryStream);
	...
	public static void x8db8994c865b7964(string x1b18a3a0e8682b51, xc68feac946ffcf6f xcdb38db96792af75, string xb41a802ca5fde63b)
	{
		if (xcdb38db96792af75 == null)
		{
			throw new ArgumentNullException("codeList");
		}
		xcdb38db96792af75.x9425d7602dc80ff4.x0acd3c2012ea2ee8(xb41a802ca5fde63b);
	}
}
